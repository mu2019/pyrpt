...
from ctypes import \
    ...
    c_ubyte, c_ushort, \
    POINTER, sizeof, alignment, Union, c_ulonglong, c_longlong, c_size_t,memmove,addressof
...
class Structure(_Structure):
    ...
    def __eq__(self, other_struct):
        ...
        if isinstance(other_struct, Structure):
...
PWINDOWINFO=LPWINDOWINFO=POINTER(WINDOWINFO)
...
class PRINTDLGW(Structure):
    ...
    def __init__(self, *args, **kw):
        super(PRINTDLGW, self).__init__(*args, **kw)
        self.lStructSize = sizeof(self)
#PRINTDLGW=tagPD=PRINTDLGW
...
# from  https://github.com/pywinauto/pywinauto/blob/master/pywinauto/win32structures.py    
...
PTEXTMETRIC=POINTER(TEXTMETRICW)
TEXTMETRIC=tagPTEXTMETRICW=TEXTMETRICW
