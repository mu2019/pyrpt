#!/usr/bin/env python
# -*- coding: utf-8 -*-
from .winmisc import  get_win_ver
...
#from https://msdn.microsoft.com/en-us/library/windows/desktop/ms646916%28v=vs.85%29.aspx
#CommDlgExtendedError return value
CDERR_STRUCTSIZE = 1
...
#https://msdn.microsoft.com/en-us/library/ff700543%28v=vs.85%29.aspx
